...
let mapleader=","
"ziven add for some Maps
nnoremap <silent> <Leader>s :w<CR>
nnoremap <silent> <Leader>v "+p
vnoremap <Leader>y "+y
nnoremap <silent> <Leader>q :q<CR>
" nnoremap <silent> <Leader>c :nohl
"ziven add for disable hlsearch temporarily by hint <esc> 
"if we already in normal mode
...
" smap <silent> <C-e> <Plug>(neocomplcache_snippets_expand)
 ...
 " plugin – a.vim
 "-----------------------------------------------------------------
"ziven modify fileencodings(add gbk)
set fileencodings=ucs-bom,utf-8,gbk,default,latin1
"ziven add for other options
set showcmd

"ziven add for ctags 20130410
set tags=tags;
set autochdir
"for taglist
" let Tlist_Ctags_Cmd = '/usr/local/bin/ctags'
"let Tlist_Auto_Open = 1 "ziven close autoopen 20130520
" let Tlist_Auto_Update = 1

"ziven add for python plugins
"for pydoc
let g:pydoc_cmd='/usr/bin/pydoc'
"for pydiction
let g:pydiction_location = '/home/android/.vim/datas/pydiction/complete-dict'
" auto close scratch after autocomplete
...
"for tagbar
"ziven mod at 20140421
nnoremap <silent> <F9> :TagbarToggle<CR>
autocmd VimEnter * nested :call tagbar#autoopen(1)    "打开vim时自动打开tagbar
" autocmd TabEnter * nested :call tagbar#autoopen(1)    "打开vim 新标签时自动打开tagbar
"for MRU
...
"imap <expr><S-TAB> neocomplcache#sources#snippets_complete#expandable() ? "\<Plug>(neocomplcache_snippets_expand)" : pumvisible() ? "\<C-p>" : "\<TAB>"
